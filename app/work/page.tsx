...
const page = () => {
  ...
  return (
    <div>
      <p className={`text-2xl bg-primary font-mono font-semibold hover:duration-150 transition-opacity ease-in duration-700 delay-300 ${isVisible1 ? "opacity-100" : "opacity-0"}`} ref={ref1} >
      ...
      <div className='grid  lg:grid-cols-2 grid-cols-1 gap-36 mt-20  '>
        ...
        {/* Price Comparison */}
        <div className={`lg:col-span-2  border-2 border-gray-100 shadow-lg hover:scale-x-105 h-[35rem] transition-opacity ease-in duration-600 delay-300 ${isVisible2 ? "opacity-100" : "opacity-0"}`} ref={ref2}>
        ...
        <Link href={"https://j5resume-parser-sage-alpha.vercel.app"} target='_blank'>
          <div className={`border-gray-100 shadow-lg  hover:scale-x-105 h-[40rem] bg-[#BEDDEF] hover:bg-white transition-opacity ease-in duration-600 delay-300 ${isVisible3 ? "opacity-100" : "opacity-0"} `} ref={ref3}>
        ...
        <Link href={"https://github.com/PhongDiep2003/Scanslate-2.0"} target='_blank'>
          <div className={`border-gray-100 shadow-lg  hover:scale-x-105 h-[40rem] transition-opacity ease-in duration-600 delay-300 ${isVisible4 ? "opacity-100" : "opacity-0"}`} ref={ref4}>
        ...
        <Link href={"https://github.com/PhongDiep2003/Youtube-Clone"} target='_blank'>
          <div className={`border-gray-100 shadow-lg h-[40rem] hover:scale-x-105 transition-opacity ease-in duration-600 delay-300 ${isVisible5 ? "opacity-100" : "opacity-0"}`} ref={ref5}>
        ...
        <Link href={"https://github.com/PhongDiep2003/Instagram-Clone"} target='_blank'>
          <div className={`border-gray-100 shadow-lg h-[40rem] hover:scale-x-105 transition-opacity ease-in duration-600 delay-300 ${isVisible6 ? "opacity-100" : "opacity-0"} `} ref={ref6}>
        ...
        <Link href={"https://github.com/PhongDiep2003/CMPE131-Project"} target='_blank'>
          <div className={`border-gray-100 shadow-lg h-[40rem] hover:scale-x-105 transition-opacity ease-in duration-600 delay-300 ${isVisible7 ? "opacity-100" : "opacity-0"} `} ref={ref7}>
        ...
        <Link href={"https://github.com/PhongDiep2003/Calculator_App"} target='_blank'>
          <div className={`border-gray-100 shadow-lg h-[40rem] hover:scale-x-105 bg-[#F7960E] hover:bg-white transition-opacity ease-in duration-600 delay-300 ${isVisible8 ? "opacity-100" : "opacity-0"}`} ref={ref8}>
        ...
        <Link href={"https://github.com/PhongDiep2003/CS157A_Project"} target='_blank'>
          <div className={`border-gray-100 shadow-lg h-[40rem] hover:scale-x-105 transition-opacity ease-in duration-600 delay-300 ${isVisible9 ? "opacity-100" : "opacity-0"}`} ref={ref9}>
